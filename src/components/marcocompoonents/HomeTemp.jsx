...
export default function HomeTemp(){
    return(
        <>
         <div className="div flex flex-cols-3 w-full  xl:w-[70%] m-auto ">
            ...
            <div className="main w-full py-5 md:w-[80%] pb-[120px] md:border-r-[1px] md:border-r-greytextfade xl:w-[50%]">
                <Outlet/>
