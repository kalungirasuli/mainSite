...
const[page,setpage]=useState(true)
    useEffect(()=>{
         window.addEventListener('DOMContentLoaded',(event)=>{
            event?setpage(true):setpage(false)
         })
    },[])
    return(
        <>
            <div className={`${!page?'m-0  w-full h-screen overflow-hidden block':'hidden'}`}>
                <div className='img w-[min-content] h-auto mt-[30%]  m-auto p-2 xl:mt-[10%]' >
                ...
                <div className="progress-bar absolute bottom-[100px] left-0 right-0 w-[70%] m-auto lg:w-[50%] bg-greytextfade xl:w-[40%]">
                    <hr className='bg-blue h-2 w-[50%]'/>
