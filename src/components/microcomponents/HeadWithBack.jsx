...
export default function HeadWithBack(props){
   ...
   const handleBack=()=>{
    ...
    return(
        <>
            <div className={` ${props.border?'border-0':'border-b-[1px] border-b-[greytextfade]'}${props.sticky?'sticky top-0':''} div w-full p-3 bg-white  flex flex-row  justify-between   z-50   `}>
...
export  function HeadWithProfile(props){
    ...
    const handleBack=()=>{
     ...
     return(
         <>
             <div className="div p-3 bg-white sticky top-0 flex flex-row  justify-between  border-b-[1px] border-b-[greytextfade] gap-[20px] z-50">
              <span className='w-[35px] align-center'>
                 <IoIosArrowBack className='fill-black text-[25px]' onClick={handleBack}/>
              </span>
