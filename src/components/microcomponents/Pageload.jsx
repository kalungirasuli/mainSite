...
export default function Pageload(){
    ...
    return(
        <>
            <div className='bg-white m-0  w-full h-screen overflow-hidden'>
                ...
                <div className="progress-bar absolute bottom-[100px] left-0 right-0 w-[70%] m-auto lg:w-[50%] bg-greytextfade">
